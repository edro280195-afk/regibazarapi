...
public interface ITandaService
{
    ...
    Task<TandaPaymentDto> VerifyPaymentAsync(Guid paymentId, VerifyTandaPaymentDto dto, CancellationToken cancellationToken = default);
    ...
    Task ReplaceParticipantItemsAsync(Guid participantId, ReplaceTandaParticipantItemsDto dto, CancellationToken cancellationToken = default);
}
