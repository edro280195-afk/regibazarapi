...
public record InventoryBoxSummaryDto(
    Guid Id,
    string Code,
    string Name,
    string? Location,
    bool IsNfcBound,
    int ArticleTypesCount,
    int TotalUnits,
    DateTime UpdatedAt
);
...
public record CreateInventoryBoxDto(
    [Required, MaxLength(30)] string Code,
    [Required, MaxLength(120)] string Name,
    [MaxLength(200)] string? Location
);

public record UpdateInventoryBoxDto(
    [Required, MaxLength(30)] string Code,
    [Required, MaxLength(120)] string Name,
    [MaxLength(200)] string? Location
);

public record BindInventoryNfcDto([Required, MaxLength(64)] string TagUid);
...
public record AdjustInventoryItemDto(
    [Range(-100000, 100000)] int QuantityDelta,
    [MaxLength(300)] string? Note
);

public record TransferInventoryItemsDto(
    Guid SourceBoxId,
